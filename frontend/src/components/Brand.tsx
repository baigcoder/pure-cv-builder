...
export const Logo = ({ width = 24, height = 24, logoColor = "#0F172A", iconColor = "white" }) => (
    <svg width={width} height={height} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <rect width="24" height="24" rx="6" fill={logoColor} />
        <path d="M8 7H12.5C14.433 7 16 8.567 16 10.5C16 12.433 14.433 14 12.5 14H10V18" stroke={iconColor} strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M10 14V7" stroke={iconColor} strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
);
...
export const Icons = {
    ...
    education: () => (
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 10L12 5 2 10l10 5 10-5z" /><path d="M6 12v5c3 3 9 3 12 0v-5" /></svg>
    ),
    skills: () => (
    ...
    design: () => (
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="13.5" cy="6.5" r=".5" /><circle cx="17.5" cy="10.5" r=".5" /><circle cx="8.5" cy="7.5" r=".5" /><circle cx="6.5" cy="12.5" r=".5" /><path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.926 0 1.607-.48 2.303-1.137C14.992 20.235 15.567 20 16 20c.926 0 1.607.48 2.303 1.137C18.992 21.765 19.567 22 20 22c1.105 0 2-1.119 2-2.5 0-6.351-4.477-10.5-10-10.5z" /></svg>
    )
};
